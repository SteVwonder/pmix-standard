...
\hspace*{4\sigspace}(pmix_status_t status,
\hspace*{5\sigspace}size_t evhdlr_ref,
\hspace*{5\sigspace}void *cbdata)
\end{signature}
...
\hspace*{24\sigspace}char *data, size_t sz,
...
\hspace*{29\sigspace}int incoming_sd, void *cbdata)
\end{signature}
...
\hspace*{29\sigspace}pmix_status_t status,
\hspace*{29\sigspace}pmix_proc_t *proc, void *cbdata)
\end{signature}
...
\hspace*{29\sigspace}pmix_status_t status,
\hspace*{29\sigspace}pmix_byte_object_t *credential,
...
\hspace*{29\sigspace}size_t iofhdlr, pmix_iof_channel_t channel,
\hspace*{29\sigspace}pmix_proc_t *source, char *payload,
\hspace*{29\sigspace}pmix_info_t info[], size_t ninfo);
\end{signature}
...
\hspace*{39\sigspace}size_t refid,
\hspace*{39\sigspace}void *cbdata);
\end{signature}
