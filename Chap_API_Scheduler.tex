...
\hspace*{4\sigspace}uint16_t **commcost;
\hspace*{4\sigspace}uint32_t nverts;
...
\hspace*{28\sigspace}const pmix_info_t directives[],
\hspace*{28\sigspace}size_t ndirs)
\end{signature}
...
\hspace*{28\sigspace}uint32_t index, pmix_value_t *vertex,
\hspace*{28\sigspace}char **nodename)
\end{signature}
...
\hspace*{22\sigspace}pmix_value_t *vertex,
\hspace*{22\sigspace}uint32_t *index)
\end{signature}
